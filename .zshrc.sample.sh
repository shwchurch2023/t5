...
echo "(sudo rm /tmp/t5_shouldExecuteStep_step; sudo chown -R hugo.hugo /mnt/hugo/github/t5; cd /mnt/hugo; sudo -u hugo zsh -c '/mnt/hugo/github/t5/bin/sync.sh > /mnt/hugo/github/sync.log 2>&1' &); tail -f /mnt/hugo/github/sync.log"
